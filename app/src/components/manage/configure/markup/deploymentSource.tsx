    ...
    return (
      <div className="col-md-12" style={{ padding: "15px" }}>
        <h4 className="oswald-header">
          <b>Deployment source</b>
        </h4>
        {!this.state.disabled && (
          <div style={{ fontSize: ".8em", padding: "2px" }}>
            Note: This must be the url to a public repository
          </div>
        )}
        <input
          ...
          onChange={e =>
            this.props.setState({ deploymentSource: e.target.value })
          }
