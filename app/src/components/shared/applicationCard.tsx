...
export default class ApplicationCard extends React.Component<props, state> {
  ...
  async source() {
    this.setState({ source: await getSource(this.props.application) });
  }
    ...
    return (
      <div className="panel">
        <div className="panel-body">
              ...
              <div className="row">
                ...
                {this.state.source && this.state.source.repo && (
                  <div className="col-md-12">
                    <div
                      onClick={() =>
                        window.open(this.state.source.repo, "_blank")
                      }
                      style={{ width: "100%", borderRadius: "0px" }}
                      className="btn btn-secondary"
                    >
          ...
          <div className="row">
            {this.state.showDeployments && (
              <Deployments application={application} />
            )}
          </div>
          <div className="row" style={{ marginTop: "15px" }}>
            ...
            <div className="col-md-4 text-center">
              <FiveHundo application={application} />
            </div>
            <div className="col-md-4 text-center">
              <FourHundo application={application} />
            </div>
          </div>
        </div>
      </div>
