...
export default class APIs extends React.Component<props, state> {
    ...
    render() {
        ...
        const currentItems = this.props.apiApps.slice(indexOfFirstItem, indexOfLastItem);
        ...
        for (let i = 1; i <= Math.ceil(this.props.apiApps.length / 10); i++) {
            pageNumbers.push(i);
        }
